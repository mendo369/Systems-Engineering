  ...
  >
    <div class="bg-black py-2 px-4 w-full flex items-center">
      <span
        ...
        Instalación de Linux Mint en una máquina virtual</span
      >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
    ...
    <div class="w-full bg-white border-t-2 border-black py-2 px-4">
      <p>
        Vamos a ver cómo podemos instalar Linux Mint en una máquina virtual en
        VirtualBox
      </p>
      <br />
      <div>
        <ol class="list-decimal">
          ...
          <li>
            <div>
              ...
              <img
                src="@/assets/images/OperatingSystems/virtualbox-2.webp"
                alt=""
              />
            </div>
          </li>
          <li>
            <div>
              ...
              <img
                src="@/assets/images/OperatingSystems/virtualbox-3.webp"
                alt=""
              />
            </div>
          </li>
          <li>
            <div>
              ...
              <img
                src="@/assets/images/OperatingSystems/virtualbox-4.webp"
                alt=""
              />
            </div>
          </li>
          <li>
            <div>
              <p>
                Una vez se ejecute el instalador le damos
                <span class="font-semibold">Next</span> a todo y esperamos a que
                finalice la instalación
              </p>
              <img
                src="@/assets/images/OperatingSystems/virtualbox-5.webp"
                alt=""
              />
            </div>
          </li>
      ...
      <div class="pl-[1.4em]">
        <YoutubeFrame
          video-url="https://www.youtube.com/embed/3EpWqt8q9sA?si=5_fBzm5jvu9j8tk4&amp;controls=0"
        ></YoutubeFrame>
      </div>
    </div>
  </div>
