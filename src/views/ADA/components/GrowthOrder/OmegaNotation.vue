  ...
  >
    ...
    <div class="w-full bg-white border-t-2 border-black py-4 px-6 space-y-4">
      <div class="flex justify-center">
        <img
          src="@/assets/images/ADA-I/notation-omega.png"
          alt="Notación Ω"
      ...
      <div class="space-y-2 text-gray-900">
        <p>
          <strong>Definición:</strong> Ω(g(n)) = { f(n) : Existen constantes
          positivas <em>c</em> y <em>n₀</em> tales que
        </p>
        <p class="pl-6">
        ...
        <p class="mt-3">
          <strong>Ejemplo:</strong> Encontrar los valores de <em>c</em> y
          <em>n₀</em> para la siguiente función:
        </p>
